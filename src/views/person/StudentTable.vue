    ...
    <div class="table-content">
      <el-table :data="dataList" :header-cell-style="{
        ...
        <el-table-column label="操作" color="black" align="center" width="260">
          <template v-slot="scope">
            <el-button class="commButton" @click="editItem(scope.row.personId)">基本信息</el-button>
            <el-button class="commButton" @click="familyMember(scope.row.personId)">家庭成员</el-button>
            <el-button class="commButton" @click="deleteItem(scope.row.personId)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    // 删除学生
    async deleteItem(personId: number) {
