<template>
  <div class="base_form">
    ...
    <div class="custom-tree-container" v-if="nodes !== null">
      <el-tree :data="nodes" show-checkbox node-key="id" default-expand-all :expand-on-click-node="false">
  ...
  <dialog id="favDialog" onclose="close()"
    ...
    <div class="dialog-div" style="margin-top: 5px">
      <table class="dialog-content">
        ...
        <tr>
          <td colspan="2">
            <button class="commButton" @click="close()" style="margin-right: 30px; margin-left: 80px">
              取消
            </button>
