<template>
  <div class="base_form">
    ...
    <div class="table_center" style="margin-top: 5px">
      <table class="content">
        ...
        <tr v-for="item in scoreList" :key="item.personId">
  ...
  <div>
    <el-upload style="display: inline-block; margin-left: 5px" :headers="authHeader"
      :action="'/api/student/importFeeDataWeb'" :data="{ personId: personId }" accept=".xlsx,.xls"
...
export default defineComponent({
  ...
  async created() {
    let res = await getStudentIntroduceData(this.personId);
